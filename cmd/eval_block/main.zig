...
const variants = [_]Variant{
    ...
    .{ .name = "fast5_full40_a14", .mode = .two_tier, .fast = 5, .full = 40, .amin = 1, .amax = 4 },
    .{ .name = "fast5_full32_a14", .mode = .two_tier, .fast = 5, .full = 32, .amin = 1, .amax = 4 },
    .{ .name = "fast6_full48_a14", .mode = .two_tier, .fast = 6, .full = 48, .amin = 1, .amax = 4 },
    .{ .name = "fast6_full40_a14", .mode = .two_tier, .fast = 6, .full = 40, .amin = 1, .amax = 4 },
    .{ .name = "fast6_full32_a14", .mode = .two_tier, .fast = 6, .full = 32, .amin = 1, .amax = 4 },
    .{ .name = "fast7_full48_a14", .mode = .two_tier, .fast = 7, .full = 48, .amin = 1, .amax = 4 },
    .{ .name = "fast7_full40_a14", .mode = .two_tier, .fast = 7, .full = 40, .amin = 1, .amax = 4 },
    .{ .name = "fast8_full48_a14", .mode = .two_tier, .fast = 8, .full = 48, .amin = 1, .amax = 4 },
    .{ .name = "fast8_full40_a14", .mode = .two_tier, .fast = 8, .full = 40, .amin = 1, .amax = 4 },
    .{ .name = "fast10_full48_a14", .mode = .two_tier, .fast = 10, .full = 48, .amin = 1, .amax = 4 },
    .{ .name = "fast12_full48_a14", .mode = .two_tier, .fast = 12, .full = 48, .amin = 1, .amax = 4 },
    .{ .name = "fast5_full48_a13", .mode = .two_tier, .fast = 5, .full = 48, .amin = 1, .amax = 3 },
    .{ .name = "fast5_full48_a23", .mode = .two_tier, .fast = 5, .full = 48, .amin = 2, .amax = 3 },
    .{ .name = "fast6_full48_a23", .mode = .two_tier, .fast = 6, .full = 48, .amin = 2, .amax = 3 },
    .{ .name = "fast6_full40_a13", .mode = .two_tier, .fast = 6, .full = 40, .amin = 1, .amax = 3 },
    .{ .name = "fast7_full40_a13", .mode = .two_tier, .fast = 7, .full = 40, .amin = 1, .amax = 3 },
    .{ .name = "fast6_full48_a24", .mode = .two_tier, .fast = 6, .full = 48, .amin = 2, .amax = 4 },
    .{ .name = "fast6_full40_a24", .mode = .two_tier, .fast = 6, .full = 40, .amin = 2, .amax = 4 },
    .{ .name = "fast6_full32_a24", .mode = .two_tier, .fast = 6, .full = 32, .amin = 2, .amax = 4 },
    .{ .name = "fast7_full40_a24", .mode = .two_tier, .fast = 7, .full = 40, .amin = 2, .amax = 4 },
    .{ .name = "fast7_full48_a24", .mode = .two_tier, .fast = 7, .full = 48, .amin = 2, .amax = 4 },
    .{ .name = "fast8_full48_a24", .mode = .two_tier, .fast = 8, .full = 48, .amin = 2, .amax = 4 },
    .{ .name = "fast5_full48_a24", .mode = .two_tier, .fast = 5, .full = 48, .amin = 2, .amax = 4 },
    .{ .name = "fast5_full40_a24", .mode = .two_tier, .fast = 5, .full = 40, .amin = 2, .amax = 4 },
    .{ .name = "fast5_full44_a24", .mode = .two_tier, .fast = 5, .full = 44, .amin = 2, .amax = 4 },
    .{ .name = "fast5_full42_a24", .mode = .two_tier, .fast = 5, .full = 42, .amin = 2, .amax = 4 },
    .{ .name = "fast5_full38_a24", .mode = .two_tier, .fast = 5, .full = 38, .amin = 2, .amax = 4 },
    .{ .name = "fast5_full36_a24", .mode = .two_tier, .fast = 5, .full = 36, .amin = 2, .amax = 4 },
    .{ .name = "fast5_full32_a24", .mode = .two_tier, .fast = 5, .full = 32, .amin = 2, .amax = 4 },
    ...
    .{ .name = "fast4_full36_a24", .mode = .two_tier, .fast = 4, .full = 36, .amin = 2, .amax = 4 },
    .{ .name = "fast3_full48_a24", .mode = .two_tier, .fast = 3, .full = 48, .amin = 2, .amax = 4 },
    .{ .name = "fast3_full40_a24", .mode = .two_tier, .fast = 3, .full = 40, .amin = 2, .amax = 4 },
    .{ .name = "fast6_full24_a24", .mode = .two_tier, .fast = 6, .full = 24, .amin = 2, .amax = 4 },
    .{ .name = "fast8_full24_a24", .mode = .two_tier, .fast = 8, .full = 24, .amin = 2, .amax = 4 },
};
